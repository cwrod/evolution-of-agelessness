...
if "C" in plot_panels:
	...
	plt.plot(dam_classes, plei_ageless_means, marker="o", label=r"All $r_{opt}=r_{max}$ (Pleiotropy)")
	...
	plt.plot(dam_classes, noplei_ageless_means, marker="o", label=r"All $r_{opt}=r_{max}$ (No pleiotropy)")
